...
public class ChooseProvider extends javax.swing.JFrame{
    ...
    private void delarceVariable()
    {
        ...
        scrollPaneNhaCungCap.getViewport().setBackground(new Color(61,62,66));
    ...
    private void setValue()
    {
        ...
        else
        {
            ...
            for(int i=0;i<renderProviderTable.getColumnCount();i++)
            {
                temp.add(tableNhaCungCap.getValueAt(row,i));
            }
            this.value=new NhaCungCap();
            value.setIdNhaCungCap((Integer) temp.get(0));
            value.setTenNhaCungCap((String) temp.get(1));
